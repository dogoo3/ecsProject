...
//     version 1.11.2
//     from Assets/Streaming/InputSystem/SphereControls.inputactions
//
...
public partial class @SphereControls: IInputActionCollection2, IDisposable
{
    ...
    ~@SphereControls()
    {
        UnityEngine.Debug.Assert(!m_ActionMap.enabled, "This will cause a leak and performance issues, SphereControls.ActionMap.Disable() has not been called.");
    }
    ...
    public struct ActionMapActions
    {
        ...
        public ActionMapActions(@SphereControls wrapper) { m_Wrapper = wrapper; }
